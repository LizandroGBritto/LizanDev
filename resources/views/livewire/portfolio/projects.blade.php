        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-3">
                    {{ __('Projects') }} <span
                        class="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">{{ __('Featured Projects') }}</span>
                </h2>
                                ...
                                <div
                                    ...
                                    <div class="relative mb-4 mini-carousel-container" data-mini-carousel="{{ $index }}">
                                        ...
                                        <div class="flex flex-col items-center gap-0.5 mt-2">
                                            ...
                                            <p class="text-slate-400" style="font-size: 0.65rem; font-style: italic;">
                                                {{ __('*Tap the image to enlarge') }}</p>
                                        </div>
                                    </div>
            ...
            <div class="mt-12 text-center">
                <p class="text-slate-300 text-sm mb-3">{{ __('Want to see more projects?') }}</p>
